...
/// </summary>
public abstract class AdvancedRepository<TEntity> : IAdvancedRepository<TEntity> where TEntity : class
{
    private readonly ApplicationDbContext _context;
    protected AdvancedRepository(ApplicationDbContext context)
    {
        _context = context;
    }
